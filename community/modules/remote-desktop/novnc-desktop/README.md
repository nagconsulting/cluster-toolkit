...
| <a name="output_network_tag"></a> [network\_tag](#output\_network\_tag) | Network tag applied to the desktop instances, for targeting firewall rules at them. |
...
| <a name="output_self_links"></a> [self\_links](#output\_self\_links) | Self links of the desktop instances, for use as load balancer backends.<br/>Pass to the https-load-balancer module's instances variable, keyed by zone. |
